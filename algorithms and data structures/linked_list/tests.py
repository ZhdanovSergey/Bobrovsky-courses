...
def linked_list_by_values_arr(arr):
  linked_list = LinkedList()
  for x in arr:
      linked_list.add_in_tail(Node(x))
  return linked_list

def linked_list_by_nodes_arr(arr):
  linked_list = LinkedList()
  for x in arr:
  	linked_list.add_in_tail(x)
  return linked_list

def check_linked_list_correct(linked_list):
	prev_node = None
...
class LinkedListTests(unittest.TestCase):
	...
	def test_iteration_regression(self):
		orig_arr = [1,2,3,4,5]
		linked_list = linked_list_by_values_arr(orig_arr)
	...
	def test_iteration_random(self):
		for i in range(1000):
			...
			linked_list = linked_list_by_values_arr(values_arr)
			self.assertEqual(values_arr, [x.value for x in linked_list])

	def test_single_deletion_regression(self):
		linked_list = linked_list_by_values_arr([1,2,3,4,5])
		linked_list.delete(3)
		self.assertTrue(check_linked_list_correct(linked_list))
	...
	def test_multiple_deletion_regression(self):
		linked_list = linked_list_by_values_arr([1,2,3,3,3,4,5])
		linked_list.delete(3, all=True)
		self.assertTrue(check_linked_list_correct(linked_list))
		self.assertEqual([x.value for x in linked_list], [1,2,4,5])

	def test_multiple_deletion_with_empty_result(self):
		linked_list = linked_list_by_values_arr([1,1,1,1,1,1])
	...
	def test_find_all_regression(self):
		...
		linked_list = linked_list_by_nodes_arr(nodes_arr)
		test_val = 1
	...
	def test_find_all_random(self):
		for i in range(1000):
			nodes_arr = [Node(randint(-10,+10)) for j in range(randint(1,100))]
	...
	def test_insert_regression(self):
		...
		linked_list = linked_list_by_nodes_arr([node1, node2])
	...
	def test_sum_of_lists_regression(self):
		linked_list1 = linked_list_by_values_arr([1,2,3])
		linked_list2 = linked_list_by_values_arr([4,5,6])
	...
	def test_sum_of_lists_with_different_len(self):
		linked_list1 = linked_list_by_values_arr([1,2,3])
		linked_list2 = linked_list_by_values_arr([4,5,6,7])
		linked_list_sum = get_sum_of_lists(linked_list1, linked_list2)
		self.assertTrue(linked_list_sum is None)

	def test_sum_of_lists_random(self):
		for i in range(1000):
			arr1 = []
			arr2 = []
			...
			for i in range(0 if randint(0,10) == 0 else randint(1,100)):
				arr2.append(randint(-10,+10))
			linked_list1 = linked_list_by_values_arr(arr1)
			linked_list2 = linked_list_by_values_arr(arr2)
			linked_list_sum = get_sum_of_lists(linked_list1, linked_list2)
			if len(arr1) == len(arr2):
				ans_arr = [arr1[j] + arr2[j] for j in range(len(arr1))]
